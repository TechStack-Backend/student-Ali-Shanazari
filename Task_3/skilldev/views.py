...
def developer_list(request):
    developers = Developer.objects.prefetch_related('project','skills').all()
    return render(request, 'skilldev/developers_list.html', {'developers':developers})

def project_list(request):
    projects = Project.objects.prefetch_related('developer').all()
    return render(request, 'skilldev/projects_list.html', {'projects':projects})
